...
ph1 = bc.BulletClient(pybullet.DIRECT)
ph2 = bc.BulletClient(pybullet.GUI)
...
panda.q = [1.0, 0.41, 0.00, -1.85, 0.00, 2.26, 0.79]

# Number of joint in the panda which we are controlling
n = 7

# Make two obstacles with velocities
s0 = sg.Sphere(radius=0.05, pose=sm.SE3(0.05+0.6,-0.2,0.1))
#s0.v = [0, -0.2, 0, 0, 0, 0]

s1 = sg.Sphere(radius=0.05, pose=sm.SE3(0.05+0.6,-0.2,0.2))
#s1.v = [0, -0.2, 0, 0, 0, 0]

collisions = [s0, s1]

# Make a target
target = sg.Sphere(radius=0.02, pose=sm.SE3(-0.2+0.6, -0.4, 0.2))
