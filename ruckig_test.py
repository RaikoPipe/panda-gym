...
if __name__ == '__main__':
    ...
    inp.current_position = [0.0, 0.0, 0.5, 0.0, 0.0, 0.0, 0.0]
    inp.current_velocity = [0.0, -2.2, -0.5, 0.3, 0.5, 0.0, 0.0]
    inp.current_acceleration = [0.0, 2.5, -0.5, 0.0, 1.0, 2.0, 1.5]

    inp.target_position = [5.0, -2.0, -3.5, 4.0, 3.2, 1.1, 2.0]
    #inp.target_velocity = [0.0, -0.5, -2.0, 0.0, -0.5, -2.0, 0.2]
    #inp.target_acceleration = [0.0, 0.0, 0.5, 1.0, 1.0, 1.0, 1.0]

    inp.max_velocity = [150, 150, 150, 150, 180, 180, 180]
    inp.max_acceleration = [150, 150, 150, 150, 180, 180, 180]
    inp.max_jerk = [150, 150, 150, 150, 180, 180, 180]
