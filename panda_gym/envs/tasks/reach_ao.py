...
class ReachAO(Task):
    ...
    def sample_work_space_goal(self):
    ...
    def set_coll_free_goal(self):
        ...
        while any(collision):
            ...
            collision.append(self.check_collision("dummy_target", "robot", margin=0.05))
            collision.append(self.check_collision("dummy_target", "table", margin=0.05))
